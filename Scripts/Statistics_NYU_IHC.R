...
previous=read.csv("~/Documents/CPTAC-UCEC/Results/Statistics_NYU_IHC.csv")
...
write.csv(New_OUTPUT, file = "~/documents/CPTAC-UCEC/Results/Statistics_NYU_IHC.csv", row.names=FALSE)
