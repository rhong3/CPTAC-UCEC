...
def resnet_v2_stem(input):
    ...
    x = Conv2D(32, (3, 3), W_regularizer=l2(0.0002), activation="relu", strides=(2, 2))(input)  # 149 * 149 * 32
    x = Conv2D(32, (3, 3), W_regularizer=l2(0.0002), activation="relu")(x)  # 147 * 147 * 32
    ...
    x2 = Conv2D(64, (1, 1), W_regularizer=l2(0.0002), activation="relu", padding="same")(x)
    x2 = Conv2D(64, (7, 1), W_regularizer=l2(0.0002), activation="relu", padding="same")(x2)
...
def inception_resnet_v2_B(input, scale_residual=True):
    ...
    br1 = Conv2D(192, (1, 1), W_regularizer=l2(0.0002), activation="relu", padding="same")(input)
...
def reduction_resnet_v2_B(input):
    ...
    rbr3 = Conv2D(288, (3, 3), W_regularizer=l2(0.0002), activation="relu", strides=(2, 2))(rbr3)
...
def inception_resnet_v2(input, dropout_keep_prob=0.8, num_classes=1000, is_training=True, scope='InceptionResnetV2'):
    ...
    with tf.variable_scope(scope, 'InceptionResnetV2', [input]):
        ...
        loss2_conv_a = Conv2D(128, (1, 1), W_regularizer=l2(0.0002), activation="relu", padding="same")(
            loss2_ave_pool)
        loss2_conv_b = Conv2D(768, (5, 5), W_regularizer=l2(0.0002), activation="relu", padding="same")(
            loss2_conv_a)
