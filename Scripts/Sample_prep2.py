...
def set_sep(alll, path, cls, cut=0.2):
    ...
    train_tiles = train_tiles.sample(frac=0.01, replace=False)
    validation_tiles = validation_tiles.sample(frac=0.01, replace=False)
    # test_tiles = test_tiles.sample(frac=0.01, replace=False)
