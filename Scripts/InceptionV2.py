...
def inceptionv2(input,
    ...
    with tf.name_scope(scope, "InceptionV2", [input]):
        ...
        inception_3a_5x5_a = Conv2D(32, (3, 3), border_mode='same', activation='relu', name='inception_3a/5x5_a',
                                         W_regularizer=l2(0.0002))(inception_3a_5x5_reduce)

        inception_3a_5x5_b = Conv2D(32, (3, 3), stride=2, border_mode='same', activation='relu', name='inception_3a/5x5_b',
        ...
        inception_3b_5x5_a = Conv2D(96, (3, 3), border_mode='same', activation='relu', name='inception_3b/5x5_a',
                                         W_regularizer=l2(0.0002))(inception_3b_5x5_reduce)

        inception_3b_5x5_b = Conv2D(96, (3, 3), stride=2, border_mode='same', activation='relu', name='inception_3b/5x5_b',
        ...
        inception_4a_5x5_a = Conv2D(48, (3, 3), border_mode='same', activation='relu', name='inception_4a/5x5_a',
                                         W_regularizer=l2(0.0002))(inception_4a_5x5_reduce)

        inception_4a_5x5_b = Conv2D(48, (3, 3), stride=2, border_mode='same', activation='relu', name='inception_4a/5x5_b',
        ...
        inception_4b_5x5_a = Conv2D(64, (3, 3), border_mode='same', activation='relu', name='inception_4b/5x5_a',
                                         W_regularizer=l2(0.0002))(inception_4b_5x5_reduce)

        inception_4b_5x5_b = Conv2D(64, (3, 3), stride=2, border_mode='same', activation='relu', name='inception_4b/5x5_b',
        ...
        inception_4c_5x5_a = Conv2D(64, (3, 3), border_mode='same', activation='relu', name='inception_4c/5x5_a',
                                         W_regularizer=l2(0.0002))(inception_4c_5x5_reduce)

        inception_4c_5x5_b = Conv2D(64, (3, 3), stride=2, border_mode='same', activation='relu', name='inception_4c/5x5_b',
        ...
        inception_4d_5x5_a = Conv2D(64, (3, 3), border_mode='same', activation='relu', name='inception_4d/5x5_a',
                                         W_regularizer=l2(0.0002))(inception_4d_5x5_reduce)

        inception_4d_5x5_b = Conv2D(64, (3, 3), stride=2, border_mode='same', activation='relu', name='inception_4d/5x5_b',
        ...
        inception_4e_5x5_a = Conv2D(128, (3, 3), border_mode='same', activation='relu', name='inception_4e/5x5_a',
                                         W_regularizer=l2(0.0002))(inception_4e_5x5_reduce)

        inception_4e_5x5_b = Conv2D(128, (3, 3), stride=2, border_mode='same', activation='relu', name='inception_4e/5x5_b',
        ...
        inception_5a_5x5_a = Conv2D(128, (3, 3), border_mode='same', activation='relu', name='inception_5a/5x5_a',
                                         W_regularizer=l2(0.0002))(inception_5a_5x5_reduce)

        inception_5a_5x5_b = Conv2D(128, (3, 3), stride=2, border_mode='same', activation='relu', name='inception_5a/5x5_b',
        ...
        inception_5b_5x5_a = Conv2D(128, (3, 3), border_mode='same', activation='relu', name='inception_5b/5x5_a',
                                         W_regularizer=l2(0.0002))(inception_5b_5x5_reduce)

        inception_5b_5x5_b = Conv2D(128, (3, 3), stride=2, border_mode='same', activation='relu', name='inception_5b/5x5_b',
