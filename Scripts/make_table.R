...
df$Feature = gsub("CNVL", "CNV-L (Serous-like) binary", df$Feature)
...
rownames(outdf_patient) = c("Histology", "CNV-H (Serous-like) binary", "CNV-H from endometrioid", "CNV-L", "MSI-High", "POLE", "ARID1A", "ATM",   
...
rownames(outdf_tile) = c("Histology", "CNV-H (Serous-like) binary", "CNV-H from endometrioid", "CNV-L", "MSI-High", "POLE", "ARID1A", "ATM",   
                            "BRCA2", "CTCF",  "CTNNB1", "FAT1",  "FBXW7", "FGFR2", "JAK1",  "KRAS",  
                            "MTOR", "PIK3CA", "PIK3R1", "PPP2R1A", "PTEN",  "RPL22", "TP53",  "ZFHX3")
